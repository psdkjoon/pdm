...
const addFlags = <FlagDef>[
  ...
  FlagDef(
    ...
    'C',
    FlagKind.string,
    'Inline cookie string "key=value; key2=value2"',
  ),
  FlagDef(
    'cookie-file',
    'J',
  ...
  FlagDef(
    ...
    'L',
    FlagKind.flag,
    'Disable exponential backoff between retries',
  ),
  FlagDef(
    'timeout',
    't',
  ...
  FlagDef(
    ...
    'l',
    FlagKind.string,
    'Max download speed, e.g. 2M, 500K',
  ),
  FlagDef(
    'checksum',
    'k',
    FlagKind.string,
    'Expected checksum "algo:hex", e.g. sha256:abc123',
  ),
  ...
  FlagDef(
    ...
    'O',
    FlagKind.flag,
    'Overwrite an existing file at the save path',
  ),
  FlagDef(
    'start-paused',
    'x',
    FlagKind.flag,
    'Add the task without starting it',
  ),
  FlagDef(
    'priority',
    'y',
  ...
  FlagDef(
    ...
    'E',
    FlagKind.string,
    'Repeat this download on an interval, e.g. 1d, 6h, 30m',
  ),
  FlagDef(
    'on-startup',
    'S',
  ...
  FlagDef(
    ...
    'D',
    FlagKind.flag,
    'Allow adding a task with a duplicate url/save path',
  ),
  FlagDef(
    'file',
    'B',
...
const watchFlags = <FlagDef>[
  ...
  FlagDef(
    ...
    'B',
    FlagKind.flag,
    'Print plain progress lines instead of a bar',
  ),
];
